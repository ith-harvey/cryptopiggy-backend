...
SELECT 1, generate_series('2017-2-21 17:00:00'::timestamp,'2018-2-22 17:00:00'::timestamp,'1 hour'::interval),to_char((random()*20000),'FM99999'),to_char((random()*300), 'FM999');
