const Resource = require('./_Resource')('performance_history_hourly')
...
class PerformanceHistoryHourly extends Resource {
  ...
  static getWindow(user_id, maxPerfWindow) {
    return db.any(`SELECT * FROM performance_history_hourly
      WHERE user_id = ${user_id}
      AND created_at >= '${maxPerfWindow}';`)
  }
}

module.exports = PerformanceHistoryHourly
